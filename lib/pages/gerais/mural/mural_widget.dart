                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      mainAxisSize: MainAxisSize.max,
                                      children: [
                                        FutureBuilder<List<MuralRow>>(
                                          future: MuralTable().queryRows(
                                            queryFn: (q) => q
                                                .eqOrNull(
                                                  'idaluno',
                                                  currentUserUid,
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<MuralRow>
                                                listViewMuralRowList =
                                                snapshot.data!;

                                            if (listViewMuralRowList.isEmpty) {
                                            ...
                                            return ListView.separated(
                                              ...
                                              itemCount:
                                                  listViewMuralRowList.length,
                                              separatorBuilder: (_, __) =>
                                                  SizedBox(height: 8.0),
                                              itemBuilder:
                                                  (context, listViewIndex) {
                                                final listViewMuralRow =
                                                    listViewMuralRowList[
                                                        listViewIndex];
                                                return Material(
                                                  color: Colors.transparent,
